...
class RoverBot(SceneObject):
    ...
    def UpdateBotFromLCM(self, bot_update):
        '''
        Update the user from a direct LCM frame of this user
        '''
        self.camScreen.SetScreenJPEGImage(self.__name, bot_update.cameraFrameJpeg)
    ...
    def __setupChildren(self, renderer):
        ...
        self.camScreen = CameraScreen.CameraScreen(renderer, self, 0.5, 2.0/3.0, 0.5, True) # Set to be an active camera.
