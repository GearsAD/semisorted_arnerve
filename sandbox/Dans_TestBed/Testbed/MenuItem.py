...
class MenuItem(SceneObject):
    ...
    def __init__(self, renderer, screenDistance, width, height, parent, name, image, callbackObject = None, callbackFunction = None):
        
        #renderer.AddObserver("LeftButtonPressEvent", self._OnButtonPress)
        
        super(MenuItem, self).__init__(renderer)
